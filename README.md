...
Aktuelle veröffentlichte Version: **v0.8.15**

Empfohlen ist die Installation über HACS. Für manuelle Installationen kann das Repository als ZIP heruntergeladen und der Ordner `custom_components/liegenschafts_mailer` nach Home Assistant kopiert werden.
